...
function data()
    return {
        ...
        ru = {
            ...
            ["Wall B"] = "Стена Б",
            ["Sync"] = "Синхронно",
            ["Altitude Adjustment"] = "Регулировка высоты",
            ...
            ["Compact Tunnel entry"] = "Компактный туннельный вход",
            ["A compact tunnel entry"] = "Компактный туннельный вход",
            ["Both"] = "Оба",
            ["Open"] = "Открыто",
            ["Closed"] = "Закрыто",
            ["Turnout #"] = "Длина изгиба #",
            ["↕↕↕↕"] = "↕↕↕↕",
            ["Number of inside tracks"] = "Количество внутренних путей",
            ["Number of outside tracks"] = "Количество внешних путей",
            ["Connection End"] = "Конец пути",
            ...
            ["Road stacking over tracks"] = "Дорога над трассой",
            ["Not build"] = "Не строить",
            ["One road stacking over one or many tracks with fix radious and signaling spacing."] = "Одна дорога над одной или несколькими трассами с фиксированным радиусом и расстоянием между сигналами",
